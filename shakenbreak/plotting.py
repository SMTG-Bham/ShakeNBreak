...
def _parse_other_charge_state_label(distortion_key: str) -> str:
    try:
        other_charge_state = int(distortion_key.rsplit("_", maxsplit=1)[-1])
        return f"From {'+' if other_charge_state > 0 else ''}{other_charge_state} charge state"
    except ValueError:
        other_charge_state = distortion_key.rsplit("_", maxsplit=1)[-1]
...
def plot_defect(
    ...
    Args:
        ...
        units (:obj:`str`):
            Units for energy, either "eV" or "meV".
            (Default: "eV")
        include_site_info (:obj:`bool`):
            Whether to include the site info (i.e. point group symbol and
            possibly nearest neighbour info, as generated by doped) in the
        ...
        include_site_info_in_name (:obj:`bool`):
            ...
            ShakeNBreak v3.4.6; use ``include_site_info`` instead.
        style_file (PathLike):
            Path to a mplstyle file to use for the plot. If None (default),
            uses the default ShakeNBreak style (``shakenbreak.mplstyle``).
        y_label (:obj:`str`):
            Y axis label
            (Default: "Energy (eV)")
        add_title (:obj:`bool`):
        ...
        save_format (:obj:`str`):
            ...
            (Default: "png")
        verbose (:obj:`bool`):
            Whether to print information about the plot (warnings and where
            it's saved).
        close_figure (:obj:`bool`):
            Whether to close matplotlib figure after saving, to reduce memory
            usage. Recommended to use if plotting many defects at once, in
            which case figure will be saved to disk and not displayed.
            (Default: False)

    Returns:
        :obj:`mpl.figure.Figure`:
            Energy vs distortion plot, as a ``Figure`` object.
    """
    if include_site_info_in_name is not None:
        warnings.warn(
            "The `include_site_info_in_name` argument of `plot_defect` is deprecated and will be "
            "removed in ShakeNBreak v3.4.6. Use `include_site_info` instead.",
            DeprecationWarning,
            stacklevel=2,
...
def _setup_plot(
    ...
    **fig_kwargs,
    ...
    try:
        formatted_defect_name = format_defect_name(defect_species, include_site_info=include_site_info)
    except Exception:
...
def plot_colorbar(
    ...
    Args:
        ...
        disp_dict (:obj:`dict`):
            ...
            ``analysis.calculate_struct_comparison()``.
        defect_species (:obj:`str`):
            Specific defect name that will appear in plot labels (in LaTeX
            form) and file names (e.g 'vac_1_Cd_0')
        include_site_info (:obj:`bool`):
            Whether to include the site info (i.e. point group symbol and
            possibly nearest neighbour info, as generated by doped) in the
            defect name. Useful for materials with many symmetry-inequivalent
        ...
        legend_label (:obj:`str`):
            ...
            (Default: 'SnB')
        metric (:obj:`str`):
            Defines the criteria for structural comparison, used for the
            colorbar. Can choose between root-mean-squared displacement for all
            sites ('disp') or the maximum distance between matched sites
            ('max_dist', default). (Default: "max_dist")
        max_energy_above_unperturbed (:obj:`float`):
            Maximum energy (in chosen ``units``), relative to the unperturbed
            structure, to show on the plot.
            (Default: 0.5 eV)
        save_plot (:obj:`bool`):
            ...
            (Default: True)
        output_path (:obj:`str`):
            Path to top-level directory containing the defect directory (in
            which to save the plot). (Default: ".")
        style_file (PathLike):
            Path to a mplstyle file to use for the plot. If None (default),
            uses the default ShakeNBreak style (``shakenbreak.mplstyle``).
        y_label (:obj:`str`):
    ...
    if include_site_info_in_name is not None:
        warnings.warn(
            "The `include_site_info_in_name` argument of `plot_colorbar` is deprecated and will be "
            "removed in ShakeNBreak v3.4.6. Use `include_site_info` instead.",
            DeprecationWarning,
            stacklevel=2,
        )  # TODO: Remove in v3.4.6
...
def plot_datasets(
    ...
    Args:
        ...
        defect_species (:obj:`str`):
            Specific defect name that will appear in plot labels (in LaTeX
            form) and file names (e.g 'vac_1_Cd_0'). Defaults to 'defect'.
        include_site_info (:obj:`bool`):
            Whether to include the site info (i.e. point group symbol and
            possibly nearest neighbour info, as generated by doped) in the
            defect name. Useful for materials with many symmetry-inequivalent
        ...
        markersize (:obj:`float`):
            ...
            (Default: None)
        linewidth (:obj:`float`):
            Linewidth to use for plots (single value, or list of values for
            each dataset). (Default: None)
        save_plot (:obj:`bool`):
    ...
    if include_site_info_in_name is not None:
        warnings.warn(
            "The `include_site_info_in_name` argument of `plot_datasets` is deprecated and will be "
            "removed in ShakeNBreak v3.4.6. Use `include_site_info` instead.",
            DeprecationWarning,
            stacklevel=2,
        )  # TODO: Remove in v3.4.6
